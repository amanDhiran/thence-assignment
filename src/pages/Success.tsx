  ...
  return (
    <Wrapper>
      <div className="h-screen">
        ...
        <div className="h-[88%] flex justify-center flex-col">
            <div className="flex flex-col gap-10 items-center">
                ...
                <div className="flex flex-col items-center max-w-[718px]">
                    <p className="font-coveredByYourGrace text-[#2da950] text-4xl">
                    success submitted
                    </p>
                    <p className="font-semibold text-[56px] text-[#1c1c1c]">
                    Congratulations
                    </p>
                    <p className="font-medium text-[#727272] text-[27px] text-center">
            ...
            <p className="text-xl mt-44 text-center  text-[#727272]">
